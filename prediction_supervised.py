...
x = list(range(0, 5564))
y = y_test.tolist()
plt.scatter(x,y_test, color = "red",label="y_test")
plt.plot(x, regressor.predict(X_test).tolist(), color = "green",label="y_test_predicted")

plt.legend(loc="upper left")

plt.title("Test data and predicted data comparision")
